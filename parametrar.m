...
=======
        feltr = 0.001;          % TrÃ¶skel fÃ¶r fel att markera i plot
        fxcount = 0;            % Antal funktioner att jÃ¤mfÃ¶ra
        fx1handle = 0;          % FÃ¶rsta funktion
        fx2handle = 0;          % Andra funktion att jÃ¤mfÃ¶ra med
>>>>>>> origin/master
    end
end
